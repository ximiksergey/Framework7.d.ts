...
// Source: https://raw.githubusercontent.com/ximiksergey/Framework7.d.ts/master/framework7.d.ts
declare namespace Framework7 {
	...
	interface PickerColumn {
		...
		onChange(picker: any, value: string, displayValue: string): void;
...
declare class Framework7 {
	...
	params: Framework7.Framework7Options;
	//device info
	android: boolean;
